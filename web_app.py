#Modified from Campusewire#969, Source: https://liangfgithub.github.io/Proj/MovieRecommendApp.html
...
from myfuns import (genres, get_displayed_movies,
...
sidebar = html.Div(
    [
        ...
        dbc.Nav(
            [
                dbc.NavLink("Movie recommendation based on your preference", href="/system-2", active="exact"),
            ],
            vertical=True,
            pills=True,
        ),
